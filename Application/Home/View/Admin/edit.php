    ...
    <div class="container">
        ...
        <form action="/Admin/update?id=<?= $model[ 'id' ] ?>" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <input value="<?= $model[ 'title' ] ?>" type="text" class="form-control" id="title" name="title"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="prompt" name="prompt" rows="3"
                          aria-describedby="promptHelp"><?= $model[ 'prompt' ] ?></textarea>
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?= $model[ 'image_link' ] ?>" name="image_link" class="form-control"
                       id="image_link" aria-describedby="image_linkHelp">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?= $model[ 'link' ] ?>" name="link" class="form-control" id="link"
            ...
            <div class="form-group form-check">
                <input type="checkbox" <?= ($model[ 'active' ]) ? 'checked=checked' : '' ?> class="form-check-input"
